      ...
      <div className="flex items-center gap-2 px-3 py-2.5 sm:px-4 sm:py-2.5">
            ...
            {channels.map((channel) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    'inline-flex min-h-9 items-center rounded-full px-3.5 py-2 text-sm font-medium transition-all sm:min-h-8 sm:py-1.5',
                    active
        ...
        <div className="flex shrink-0 items-center gap-1.5">
          ...
          <button
            ...
            className="flex h-9 w-9 items-center justify-center rounded-full bg-[var(--text-primary)] text-[var(--surface-card)] transition-all hover:-translate-y-0.5 disabled:cursor-not-allowed disabled:opacity-65 sm:h-8 sm:w-8"
          >
