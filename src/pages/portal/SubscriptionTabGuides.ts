...
export function buildClientGuide(
      ...
      steps: isZh
        ? [
            ...
            createStep(
              ...
              '如果配置导入后规则组不完整，先检查是不是用了 Shadowrocket / V2Ray 链接。',
              '下载配置',
        ...
        : [
            ...
            createStep(
              ...
              'If groups or fields look incomplete after import, check that you did not use the Shadowrocket / V2Ray link.',
              'Download profile',
  ...
  if (clientId === 'exclave') {
    return {
      recommendedFormat: 'universal',
      note: isZh
        ? 'Exclave 的导入路径和经典安卓 V2Ray 客户端接近，优先用 Shadowrocket / V2Ray 链接会更稳。'
        : 'Exclave stays close to classic Android V2Ray clients, and the Shadowrocket / V2Ray link is usually the safest import path.',
      steps: isZh
        ? [
            createStep(
              'launch',
            ...
            createStep(
              'import',
              '优先粘贴 Shadowrocket / V2Ray 订阅链接',
              '保持当前页面为 Shadowrocket / V2Ray，再把复制的订阅链接粘贴到 Exclave。',
              '如果你刚复制过链接，优先尝试 URL 或剪贴板导入。',
              'URL 导入',
              ['Shadowrocket / V2Ray 格式', '粘贴 URL', '保存 / 更新'],
              '导入订阅',
            ),
            createStep(
              'connect',
        ...
        : [
            ...
            createStep(
              'import',
              'Prefer the Shadowrocket / V2Ray subscription link',
              ...
              'Import by URL',
              ['Shadowrocket / V2Ray format', 'Paste URL', 'Save / Update'],
              'Import subscription',
            ),
            createStep(
              'connect',
    ...
    steps: isZh
      ? [
          ...
          createStep(
            ...
            '这里一定要用 Clash 格式链接，不要把 Shadowrocket / V2Ray 链接贴进来。',
            'Subscription URL',
    ...
    steps: isZh
      ? [
          ...
          createStep(
            ...
            '这里要用 Clash 格式的订阅，不要把 Shadowrocket / V2Ray 链接贴进来。',
            '配置导入',
      ...
      : [
          ...
          createStep(
            ...
            'Use the Clash-formatted link here, not the Shadowrocket / V2Ray link.',
            'Config import',
    ...
    steps: isZh
      ? [
          ...
          createStep(
            ...
            '这里要用 Clash 格式，不要把 Shadowrocket / V2Ray 链接直接贴到 FlClash 里。',
            'URL 导入',
      ...
      : [
          ...
          createStep(
            ...
            'Use the Clash link here instead of the Shadowrocket / V2Ray link.',
            'URL import',
    ...
    steps: isZh
      ? [
          ...
          createStep(
            ...
            'Surge 更适合直接使用 Surge 格式订阅，不建议这里贴 Shadowrocket / V2Ray。',
            '新建配置',
    ...
    steps: isZh
      ? [
          ...
          createStep(
            ...
            'ClashBox 最稳妥的导入方式还是 Clash 格式，不要先贴 Shadowrocket / V2Ray。',
            '导入配置',
            ['Clash 格式', '粘贴 URL', '保存配置'],
            '保存订阅',
            {
    ...
    steps: isZh
      ? [
          ...
          createStep(
            ...
            'Meta 系客户端同样应该优先使用 Clash 格式，别先贴 Shadowrocket / V2Ray。',
            '新增配置',
