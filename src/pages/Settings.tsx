          ...
          <Card>
            ...
            <CardContent className="space-y-5">
              {!isEditingSubscriptionNodes ? (
                ...
                <>
                  <textarea
                    className="min-h-[220px] w-full rounded-[22px] border border-[color:var(--border-subtle)] bg-[var(--surface-card)] px-4 py-3 font-mono text-base leading-6 text-[var(--text-primary)] shadow-sm sm:text-xs placeholder:text-[var(--text-tertiary)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--accent)] focus-visible:ring-offset-2"
