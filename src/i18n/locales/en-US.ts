export const enUS = {
  ...
  dashboard: {
    ...
    upload: 'Upload',
    help: {
      totalClients: 'Total client entries from all inbounds.',
      activeClients: 'Clients with active status and recent traffic.',
      ...
      serverStatus: 'Live server resource usage.',
  ...
  inbounds: {
    title: 'Inbounds',
    subtitle: 'Manage Xray inbound configurations.',
    ...
    noInboundsConfigured: 'No inbounds configured yet.',
    clearSearch: 'Clear Search',
    note: 'Changes here take effect immediately.',
    ...
    trafficResetHint:
      'Maps to 3X-UI inbound-level periodic reset; clears traffic counters for the inbound and its clients.',
    trafficResetOverriddenHint:
      'Disabled: a Prism billing day is set, so Prism handles the monthly reset. Clear it to re-enable.',
    ...
    billingDayHint:
      'UTC day (1–31) when Prism resets this inbound, matching DMIT-style billing cycles. Falls back to the last day for shorter months. Setting this forces 3X-UI periodic reset to "Never" to avoid double resets.',
    help: {
  ...
  users: {
    ...
    editClientDescription: "Update this client's 3X-UI config.",
    editClientConfigUnavailable: 'Cannot edit — full config unavailable.',
    editClientIdMissing: 'Missing the client ID required by 3X-UI.',
    ...
    clientActivityDescription: 'Last online time and recent IP records for this client.',
    ...
    noIpRecords: 'No IP records.',
    resetClientTraffic: 'Reset traffic',
    resetClientTrafficConfirm: 'Reset traffic for {username}? This cannot be undone.',
    ...
    deleteClientConfirm: 'Delete {username} from {inbound}? This cannot be undone.',
  ...
  nodes: {
    ...
    intro:
      'Live inbound metrics grouped as node cards. Protocol and routing changes go to Inbounds.',
    online: 'online',
    offline: 'offline',
    clients: 'Clients',
    traffic: 'Traffic',
  ...
  online: {
    title: 'Online Users',
    subtitle: 'Active clients estimated from live traffic counters.',
    refresh: 'Refresh',
    ...
    noActivity: 'No clients with active traffic.',
    ...
    copySubLink: 'Copy subscription link',
    help: {
      activeConnections: 'Counted online when status is active and cumulative traffic > 0.',
  ...
  traffic: {
    ...
    subtitle: 'Cumulative usage from 3X-UI inbounds and clients.',
    note: '3X-UI exposes cumulative counters only, not per-minute billing.',
    ...
    help: {
      ...
      avgTrafficPerClient: 'Total traffic divided by client count.',
      topClients: 'Top 10 clients ranked by cumulative traffic (GB).',
      protocolDist: 'Cumulative traffic distribution by protocol.',
      inboundUploadDownload: 'Per-inbound cumulative download/upload comparison in GB.',
    },
  },
  subscriptions: {
    title: 'Subscriptions',
    subtitle: 'Generate and share subscription links for a subId.',
    synced: '3X-UI Synced',
    subIdTitle: 'subId',
    subIdDescription: 'Paste a subId from Users or User Accounts.',
    ...
    linkCopiedImport: 'Copied. Import in your client.',
    showQr: 'Show QR',
    ...
    statInputHint: 'Enter a subId to view client stats.',
    ...
    validSubIdFirst: 'Enter a valid subId',
    ...
    tip: 'Quick start: copy the {name} link.',
    help: {
  ...
  userAuth: {
    ...
    createDesc: 'Enter your invite code, username, and password to create an account.',
    ...
    loginFailed: 'Login failed',
    adminUseLogin: 'Use the main sign-in page at /login.',
    ...
    resetSuccess: 'Password reset. Sign in again.',
    resetNow: 'Reset now',
    resetting: 'Resetting...',
  ...
  portal: {
    signOut: 'Sign out',
    subscriptionTitle: 'Subscription Link',
    subscriptionDesc: 'Copy the link and import it into your proxy client.',
    copySubscriptionUrl: 'Copy Subscription URL',
    copied: 'Copied!',
    notReadyTitle: 'Subscription not set up yet.',
    notReadyDesc: "Still being prepared. If it's taking too long, check Help.",
    howToUse: 'How to Use',
    howToUse1: 'Download a client from the list below.',
    howToUse2: 'Copy the subscription URL above.',
    howToUse3: 'In the client, choose "Add Subscription" or "Import URL" and paste.',
    howToUse4: 'Pick a server and connect.',
    downloadClient: 'Download a Client',
    recommendedFor: 'Recommended for {platform}',
    advancedRules: 'Best for rule-based clients',
    easyToUse: 'Cross-platform, easy to set up',
  ...
  systemNotifications: {
    serverOkTitle: '3X-UI connected',
    serverOkBody: 'Panel connected and responding.',
    ...
    publicUrlMissingBody: 'Set a public URL in Settings for share and reset links.',
    ...
    autoProvisionReadyBody: 'Invite registrations auto-get a 3X-UI account.',
    ...
    announcementInactiveBody: 'No announcement shown to users.',
  },
  profile: {
    title: 'Profile',
  ...
  userAccounts: {
    title: 'Users & Invites',
    subtitle: 'Friend accounts and invite codes.',
    inviteCodes: 'Invite Codes',
    generate: 'Generate',
    noInviteCodes: 'No invite codes yet. Click Generate.',
    inviteCode: 'Invite',
    noInviteUsed: 'No invite record',
    ...
    registrationTip:
      'With auto-provision on, new users automatically get a 3X-UI account. You can also assign subId manually.',
    ...
    onlineDevices: 'Online · {count} devices',
    ...
    autoProvisionOff: 'Auto-provision off. New users need manual subId assignment.',
    ...
    deleteUserConfirm:
      'Delete {username}? Removes login, sessions, reset links, and invite records.',
    userDeleted: 'User deleted: {username}',
    userDeleteFailed: 'Failed to delete user',
  },
  settings: {
    title: 'Settings',
    subtitle: 'Panel configuration and maintenance.',
    generalTitle: 'General Settings',
    generalDesc: 'Basic panel info visible across the workspace.',
    siteName: 'Site Name',
    publicUrl: 'Public URL',
    supportTelegram: 'Support Telegram',
    saveChanges: 'Save Changes',
    systemAnnouncement: 'System Announcement',
    announcementDesc: 'Shown to all users in the portal.',
    ...
    noBackup: 'No backup this session.',
    ...
    passwordHint: 'Change admin password in 3X-UI panel settings',
    twoFactorHint: 'Configure 2FA in 3X-UI panel settings',
  },
  guides: {
    clashVerge: {
      windows: {
